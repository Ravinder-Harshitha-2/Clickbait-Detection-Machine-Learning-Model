...
def predict_clickbait():
    ...
    prediction = detect_clickbait(input_text)
...
detect_button = Button(start_frame, text="Detect", fg="white", bg="#4f56e6", bd = 0, font=("Lucida Sans", 10, "bold"), command= predict_clickbait)
